...
from app.core.security import generate_api_key, verify_api_key, get_prefix_display
from app.models.api_key import ApiKey
from app.schemas.api_key import ApiKeyCreate, ApiKeyResponse, ApiKeyResponseWithSecret, VerifyRequest, VerifyResponse
...
async def verify_key(
    ...
    result = await db.execute(
        select(ApiKey).where(ApiKey.public_id == public_id, ApiKey.is_active == True)
    )
